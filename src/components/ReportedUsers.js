...
// function Users({props,route,navigation}){
 const ReportedUsers = props => {
  ...
  const [buttonIdd, setButtonId] = React.useState('');
    ...
    const url='http://192.168.6.136:1234/mantis/api/rest/issues+'+global.uid+'/?filter_id=reported';
...
<TextInput
    ...
    <ActivityIndicator size="large" color="grey" />
            ...
            (
                ...
                <View  >
                     <Text style={styles.title}>{ 'Reported by me'}</Text>
                {/* <FlatList
...
const styles = StyleSheet.create({
  ...
  cupertinoSearchBarBasic2: {
    ...
    ReportedUsers.navigationOptions = {
        headerRight: (
            <View>
